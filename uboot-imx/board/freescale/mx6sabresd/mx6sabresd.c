...
iomux_v3_cfg_t const i2c3_pads[] = {
	MX6_PAD_EIM_D18__I2C3_SDA			| MUX_PAD_CTRL(NO_PAD_CTRL),	/* POWER */
	MX6_PAD_EIM_D17__I2C3_SCL			| MUX_PAD_CTRL(NO_PAD_CTRL),	/* RESET */
};
static void setup_i2c3(void)
{
...
static void enable_lvds(struct display_info_t const *dev)
{
	...
	if((dev->pixfmt == IPU_PIX_FMT_RGB666) || (dev->pixfmt == IPU_PIX_FMT_RGB565)) {
		reg |= IOMUXC_GPR2_DATA_WIDTH_CH0_18BIT;
	} else if(dev->pixfmt == IPU_PIX_FMT_RGB24) {
